    ...
    <div className="w-full pb-28">
      ...
      <div className="px-4 pt-5">
        ...
        <div className="flex items-baseline gap-3 mt-3">
          <p className="font-dm font-bold text-2xl text-[#111]">${product.price.toLocaleString("es-AR")}</p>
          {product.originalPrice && (
            <p className="font-dm text-base text-[#AAA] line-through">${product.originalPrice.toLocaleString("es-AR")}</p>
          )}
        </div>
