  ...
  return (
    <div className="w-full min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-bebas text-4xl tracking-tight text-[#111] mb-1">INICIAR SESIÓN</h1>
        <p className="font-dm text-sm text-[#888] mb-8">
          ¿No tenés cuenta?{" "}
          <Link href="/registro" className="text-[#111] font-semibold underline">
            Registrate
          </Link>
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <p className="font-dm text-xs text-[#E63A2E]">{error}</p>
          )}
