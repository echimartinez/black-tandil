...
export const metadata: Metadata = {
  ...
  title: {
    default: "BLACK — Ropa urbana",
    template: "%s | BLACK",
  },
  description: "Tienda de ropa urbana. Buzos, remeras, pantalones y más. Envíos a todo el país.",
  keywords: ["ropa urbana", "streetwear", "indumentaria", "buzos", "remeras", "Argentina", "somosblack"],
  authors: [{ name: "BLACK" }],
  creator: "BLACK",
  openGraph: {
    type: "website",
  ...
  twitter: {
    ...
    title: "BLACK — Ropa urbana",
    description: "Tienda de ropa urbana. Envíos a todo el país.",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
            ...
            <footer className="bg-[#111] text-white mt-12">
              <div className="w-full px-4 py-8">
                ...
                <div className="border-t border-[#333] mt-6 pt-4 text-xs text-[#555] font-dm">
                  © {new Date().getFullYear()} BLACK. Todos los derechos reservados.
                </div>
              </div>
            </footer>
            <CartDrawer />
